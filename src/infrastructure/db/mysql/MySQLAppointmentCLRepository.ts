...
// import {AppointmentCLModel} from "@src/infrastructure/db/models/AppointmentCLModel";

let pool: mysql.Pool | null = null;

export class MySQLAppointmentCLRepository implements AppointmentRepositoryMySQL {
    ...
    async save(appointment: Appointment): Promise<void> {
        ...
        try {
            ...
            throw new Error(`Database CHILE Error: ${error}`);
        } finally {
            connection.release();
        }
    }
    ...
    //             const appointmentData = AppointmentCLModel.fromDatabase(row);
